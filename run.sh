...
CUDA_VISIBLE_DEVICES=0,1 torchrun --nproc_per_node 2 --master_port 28100 search.py --cfg config/imagenet-100.yaml --pretrained ../results/in100_random_sam/best_model.pth --name evolution